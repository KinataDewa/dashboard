...
<div class="row g-4">
    ...
    <div class="col-lg-8">
            ...
            <div style="overflow-x:auto;">
                <table class="ac-table-v2">
                    ...
                    <tbody>
                        ...
                        <tr style="{{ $isDE ? 'background:rgba(239,68,68,.03);' : '' }}">
                            ...
                            <div class="score-bar">
                                <div class="score-bar-fill"
                                    style="width:{{ min(($nilai->nilai_akhir / 4) * 100, 100) }}%;
                        ...
                        @empty
                        <tr><td colspan="4" style="text-align:center;padding:24px;color:var(--text-3);">Belum ada data nilai.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
        ...
        <div class="card-white tbl-card-v2">
            ...
            @else
            <div style="text-align:center;padding:24px;color:var(--text-3);">Belum ada data absensi untuk semester ini.</div>
            @endif
        </div>
    </div>
