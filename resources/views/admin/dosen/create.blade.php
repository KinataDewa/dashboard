...
<div class="section-card">
    <div class="section-title mb-4">Form Tambah Dosen</div>
    ...
    <form action="{{ route('admin.dosen.store') }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6"><label style="{{ $labelStyle }}">NIP *</label><input type="text" name="nip" value="{{ old('nip') }}" required style="{{ $inputStyle }}"></div>
            <div class="col-md-6"><label style="{{ $labelStyle }}">Nama Lengkap *</label><input type="text" name="nama" value="{{ old('nama') }}" required style="{{ $inputStyle }}"></div>
            <div class="col-md-6"><label style="{{ $labelStyle }}">Email *</label><input type="email" name="email" value="{{ old('email') }}" required style="{{ $inputStyle }}"></div>
            <div class="col-md-6"><label style="{{ $labelStyle }}">Password *</label><input type="password" name="password" required style="{{ $inputStyle }}"></div>
            <div class="col-md-6"><label style="{{ $labelStyle }}">No. HP</label><input type="text" name="no_hp" value="{{ old('no_hp') }}" style="{{ $inputStyle }}"></div>
        </div>
